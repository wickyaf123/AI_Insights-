...
import { XorYorZType, XorYType } from 'recharts/types/state/selectors/selectTooltipAxisType';
...
export declare const selectDomainOfStackGroups: ((state: import("redux").EmptyObject & {
    ...
    polarOptions: import("recharts/types/state/polarOptionsSlice").PolarChartOptions | null;
    referenceElements: {
